...
class UpdatePreventiveMaintenancePlanCommand:
    code: str
    asset_code: str
    title: str
    frequency_days: int
...
@dataclass(frozen=True)
class UpdatePreventiveMaintenancePlanResult:
    plan: PreventiveMaintenancePlan


class UpdatePreventiveMaintenancePlan:
    ...
    def execute(
        ...
        return UpdatePreventiveMaintenancePlanResult(
            plan=plan
        )